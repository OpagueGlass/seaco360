...
// Derived from 2018 codebook definition for consistency
...
const catMappings = new Map([
  ...
  ["heartdis", { name: "heartDisease", map: binaryOption }],
  ["asthma", { name: "asthma", map: binaryOption }],
  ["stroke", { name: "stroke", map: binaryOption }],
  ["arthritis", { name: "arthritis", map: binaryOption }],
  ["kidneydis", { name: "kidneyDisease", map: binaryOption }],
  ["dengue", { name: "hadDengueBefore", map: binaryOption }],
  ["denpastyear", { name: "hadDenguePastYear", map: binaryOption }],
  ["uti", { name: "hadUTIPastYear", map: binaryOption }],
  ["eversmoke", { name: "hadSmokeBefore", map: binaryOption }],
  ["smoker", { name: "isCurrentlySmoking", map: binaryOption }],
  ["bmicat_who", { name: "bmiCategory", map: new Map(bmiCategory) }],
  ["centralob", { name: "centralObesity", map: binaryOption }],
  ["hpt_screened", { name: "hypertensionScreened", map: binaryOption }],
  ["hpt_diagnosed", { name: "hypertensionDiagnosed", map: binaryOption }],
  ["hpt_measured", { name: "hypertensionMeasured", map: binaryOption }],
  ["dm_screened", { name: "diabetesScreened", map: binaryOption }],
  ["dm_diagnosed", { name: "diabetesDiagnosed", map: binaryOption }],
  ["dm_measured", { name: "diabetesMeasured", map: binaryOption }],
] as const);
...
const optCatMappings = new Map([
  ["dialysis", { name: "underDialysis", map: binaryOption }],
  ["inadequate_fruits", { name: "inadequateFruit", map: binaryOption }],
  ["inadequate_veg", { name: "inadequateVegetable", map: binaryOption }],
] as const);
